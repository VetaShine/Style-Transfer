...
| Минеева С.А        | М8О-410Б-21       | обучение модели стилизации, интеграция моделей стилизации и детекции, разработка Telegram-бота и его интеграция с сервером, реализация внутренней логики сервера, оформление документации|
